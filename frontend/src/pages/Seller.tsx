...
function Seller() {
  ...
  const [formdata,setFormdata] = useState <ISeller> ({});
    ...
    <div className='flex flex-col items-center m-3 sm:m-5 md:m-10 gap-5'>
      ...
      <form className="flex flex-col gap-5 w-full" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          ...
          <input type="text" id="name" placeholder="Company name" required className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="email" className="min-w-64" >Enter your contact email :</label>
          <input type="email" id="email" placeholder="Contact Email" required className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="phone" className="min-w-64">Enter your contact Phone No. :</label>
          <input type="text" id="phone" placeholder="Contact Phone No." required className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="address" className="min-w-64">Enter full delivery pick-up address :</label>
          <textarea name="address"  id="address" placeholder="Address" required className="h-48 w-sm sm:w-md" onChange={handleChange}/>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          ...
          <input type="text" id="Bank_Name" placeholder="Bank Name" className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="Bank Branch" className="w-48">Enter the Branch:</label>
          <input type="text" id="Bank_branch" placeholder="Bank Branch" className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="accnt_no" className="w-48">Enter your Account No. :</label>
          <input type="text" id="Bank_accnt_no" placeholder="Account Number" className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
          <label htmlFor="code" className="w-48">Enter the IFSC Code :</label>
          <input type="text" id="Bank_code" placeholder="IFSC Code" className="w-sm sm:w-md" onChange={handleChange}/>
        </div>
